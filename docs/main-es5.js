...
var NgxDurationInputDirective = /** @class */ (function () {
    ...
    NgxDurationInputDirective_1 = NgxDurationInputDirective;
    NgxDurationInputDirective.prototype.blur = function (value) {
        this.updateValue(value);
        this.onTouchedCallback();
    };
    NgxDurationInputDirective.prototype.enter = function (value) {
        this.updateValue(value);
    };
    NgxDurationInputDirective.prototype.updateValue = function (value) {
        // update display value
        this.writeValue(value);
        // updates ngModel value based on input
        this.onChangeCallback(this.durationService.parseDurationString(value));
    };
    NgxDurationInputDirective.prototype.validate = function (_) {
    ...
    NgxDurationInputDirective.prototype.writeValue = function (inputValue) {
    ...
    NgxDurationInputDirective.prototype.registerOnChange = function (fn) {
        this.onChangeCallback = fn;
    };
    NgxDurationInputDirective.prototype.registerOnTouched = function (fn) {
        this.onTouchedCallback = fn;
    };
    NgxDurationInputDirective.prototype.setDisabledState = function (isDisabled) { };
            ...
            providers: [
                {
                    ...
                    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () { return NgxDurationInputDirective_1; }),
                    multi: true
                },
                {
...
var NgxDurationInputService = /** @class */ (function () {
    ...
    NgxDurationInputService.prototype.getDurationString = function (duration) {
        if (isNaN(duration)) {
            return null;
        }
        var value = '';
    ...
    NgxDurationInputService.prototype.parseDurationString = function (value) {
        value = (value + " ").trim();
    ...
    NgxDurationInputService.prototype.isParseable = function (value) {
        if (this.isEmptyString(value)) {
            return false;
        }
        return !!value.match(this.durationRegex);
    };
    NgxDurationInputService.prototype.isEmptyString = function (value) {
        return (value + " ").trim() === '';
    };
    NgxDurationInputService.prototype.stdizeSeparator = function (value) {
        return value.replace(',', '.');
    };
    NgxDurationInputService.prototype.stdizeHour = function (value) {
        return value
            .toLocaleLowerCase()
            .replace('ó', 'h')
            .replace(':', 'h');
    };
    NgxDurationInputService.prototype.removeMin = function (value) {
        return value
            .toLocaleLowerCase()
            .replace('p', '')
            .replace('m', '');
    };
    NgxDurationInputService.prototype.removeHour = function (value) {
        return value
            .toLocaleLowerCase()
            .replace('ó', '')
            .replace('h', '')
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getValue = function (value) {
